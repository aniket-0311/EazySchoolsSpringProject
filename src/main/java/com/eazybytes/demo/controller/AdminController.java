...
import com.eazybytes.demo.model.EazyClass;
import com.eazybytes.demo.model.Person;
import com.eazybytes.demo.repository.CoursesRepository;
import com.eazybytes.demo.repository.EazyClassRepository;
...
public class AdminController {
    ...
    public ModelAndView addNewClass(Model model, @ModelAttribute("eazyClass") EazyClass newClass) {
        eazyClassRepository.save(newClass);
    ...
    public ModelAndView displayStudents(Model model, @RequestParam int classId, HttpSession session,
        ...
        if(error != null) {
            errorMessage = "Invaild Email entered!";
