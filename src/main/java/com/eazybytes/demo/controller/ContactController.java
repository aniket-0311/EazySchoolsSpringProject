...
import com.eazybytes.demo.service.ContactService;
...
public class ContactController {
    ...
    public ModelAndView displayMessages(Model model,@PathVariable int pageNum,@RequestParam("sortField") String sortField,
